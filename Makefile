...
Mgoogle/protobuf/field_mask.proto=github.com/gogo/protobuf/types:\
$$GOPATH/src/ \
		proto/authCert.proto
	# gvm issue :  move the genrated file to current directory
	mv $$GOPATH/src/authCert.pb.go $(CURDIR)/proto/
	mv $$GOPATH/src/authCert.validator.pb.go $(CURDIR)/proto/
	mv $$GOPATH/src/authCert.pb.gw.go $(CURDIR)/proto/
	## Workaround for https://github.com/grpc-ecosystem/grpc-gateway/issues/229.
	sed -i.bak "s/empty.Empty/types.Empty/g" proto/authCert.pb.gw.go && rm proto/authCert.pb.gw.go.bak
